...
//Capriccio Items
extern const u16 gItemIconPalette_Moluganion[];
extern const u16 gItemIconPalette_CursedFang[];
extern const u16 gItemIconPalette_CrimsonLens[];
extern const u16 gItemIconPalette_Skub[];
extern const u16 gItemIconPalette_Microphone[];
extern const u16 gItemIconPalette_MalachitePaint[];
extern const u16 gItemIconPalette_InsanityMask[];
extern const u16 gItemIconPalette_PoterPinkPaint[];
extern const u16 gItemIconPalette_LeadWhitePaint[];
extern const u16 gItemIconPalette_CobaltVioletPaint[];
extern const u16 gItemIconPalette_PhthaloGreenPaint[];
extern const u16 gItemIconPalette_AzumaritePaint[];
extern const u16 gItemIconPalette_PyrroleOrangePaint[];
extern const u16 gItemIconPalette_HansaYellowPaint[];
extern const u16 gItemIconPalette_CarbonBlackPaint[];
extern const u16 gItemIconPalette_UltramarinePaint[];
extern const u16 gItemIconPalette_BurntSiennaPaint[];
extern const u16 gItemIconPalette_CeruleanBluePaint[];
extern const u16 gItemIconPalette_UmberPaint[];
extern const u16 gItemIconPalette_TitaniumWhitePaint[];
extern const u16 gItemIconPalette_HeliotropePaint[];
extern const u16 gItemIconPalette_QuinacridonePaint[];
extern const u16 gItemIconPalette_YellowOchrePaint[];
extern const u16 gItemIconPalette_Whetstone[];
extern const u16 gItemIconPalette_JoyfulMask[];
extern const u16 gItemIconPalette_RagingMask[];
extern const u16 gItemIconPalette_SobbingMask[];
...
extern const u32 gItemIcon_Skub[];
extern const u32 gItemIcon_Microphone[];
extern const u32 gItemIcon_MalachitePaint[];
extern const u32 gItemIcon_InsanityMask[];
extern const u32 gItemIcon_PoterPinkPaint[];
extern const u32 gItemIcon_LeadWhitePaint[];
extern const u32 gItemIcon_CobaltVioletPaint[];
extern const u32 gItemIcon_PhthaloGreenPaint[];
extern const u32 gItemIcon_AzumaritePaint[];
extern const u32 gItemIcon_PyrroleOrangePaint[];
extern const u32 gItemIcon_HansaYellowPaint[];
extern const u32 gItemIcon_CarbonBlackPaint[];
extern const u32 gItemIcon_UltramarinePaint[];
extern const u32 gItemIcon_BurntSiennaPaint[];
extern const u32 gItemIcon_CeruleanBluePaint[];
extern const u32 gItemIcon_UmberPaint[];
extern const u32 gItemIcon_TitaniumWhitePaint[];
extern const u32 gItemIcon_HeliotropePaint[];
extern const u32 gItemIcon_QuinacridonePaint[];
extern const u32 gItemIcon_YellowOchrePaint[];
extern const u32 gItemIcon_Whetstone[];
extern const u32 gItemIcon_JoyfulMask[];
extern const u32 gItemIcon_RagingMask[];
extern const u32 gItemIcon_SobbingMask[];
