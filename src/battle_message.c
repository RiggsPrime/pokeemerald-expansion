...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_HORRORALREADYGRASS]                   = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} is already Grass-type!"),
    ...
    [STRINGID_TARGETISBEINGMUDMAELSTORMED]          = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} is being afflicted with the Maelstorm!"),
    [STRINGID_TARGETISHURTBYMUDMAELSTORM]           = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} is hurt by {B_BUFF1}!"),
    ...
    [STRINGID_INVERTEDAREACREATED]                  = COMPOUND_STRING("An inverted area was created in which\ntype effectiveness is swapped!"),
    [STRINGID_INVERSEROOMENDS]                      = COMPOUND_STRING("Inverse Room wore off, and type\neffectiveness returned to normal!"),
    [STRINGID_TYPESBECAMEINVERTED]                  = COMPOUND_STRING("Type effectiveness was\ninverted!"),
    [STRINGID_ATTACKERACQUIREDTYPE]                 = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} acquired\n{B_DEF_NAME_WITH_PREFIX}'s primary type!"),
    [STRINGID_TRANSFUSIONOVER]                      = COMPOUND_STRING("All types were reverted\nback to normal!"),
    [STRINGID_PKMNSHOTITEM]                         = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} shot the fragments\nof {B_LAST_ITEM}!"),
    [STRINGID_FOUNDAGEM]                            = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} found a {B_BUFF1} Gem!"),
    [STRINGID_ATTACKERLOSTGRASSTYPE]                = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} uprooted itself!"),
    [STRINGID_PKMNRAISEDATKPOWER]                   = COMPOUND_STRING("{B_ATK_PREFIX2}'s {B_CURRENT_MOVE}\nraised attack power!"),
    [STRINGID_SOULCRUSHED]                          = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} crushes their soul,\nclaiming it for itself!"),
    [STRINGID_TRICKSTABILLUSIONWOREOFF]             = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s Illusion wore off!"),
    [STRINGID_ATTACKERWASBURIED]                    = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} was buried!"),
    [STRINGID_BURIED]                               = COMPOUND_STRING("buried state"),
    [STRINGID_TARGETWASTRAPPED]                     = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} was trapped!"),
    [STRINGID_TEMP_TRAPPED]                         = COMPOUND_STRING("trapped state"),
