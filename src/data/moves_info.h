...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_SEED_BOMB] =
    {
        ...
        .ballisticMove = TRUE,
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_LEECH_SEED_ON_HIT,
            .chance = 30,
        }),
        .contestEffect = CONTEST_EFFECT_HIGHLY_APPEALING,
        .contestCategory = CONTEST_CATEGORY_SMART,
    ...
    [MOVE_SHADOW_SCALES] =
    {
        .name = COMPOUND_STRING("Shadow Scales"),
        .description = COMPOUND_STRING(
            "Shrouds the target with\n"
            "dark scales. Drops Defense."),
        .effect = EFFECT_HIT,
        .power = 110,
        .type = TYPE_GHOST,
        .accuracy = 100,
    ...
    [MOVE_MORE_GUN] =
    {
        .name = COMPOUND_STRING("More Gun"),
        .description = COMPOUND_STRING(
            "And if that don't work?\n"
            "Use more gun. Hits 6 times."),
        .effect = EFFECT_HIT,
        .power = 16,
        .type = TYPE_NORMAL,
        .accuracy = 100,
    ...
    [MOVE_TURNABOUT] =
    {
        .name = COMPOUND_STRING("Turnabout"),
        .description = COMPOUND_STRING(
            "Swaps the field effects\n"
            "and stats on each side."),
        .effect = EFFECT_TURNABOUT,
        .power = 0,
        .type = TYPE_GHOST,
        .accuracy = 0,
        .pp = 10,
    ...
    [MOVE_AWAKEN] =
    {
        .name = COMPOUND_STRING("Awaken"),
        .description = COMPOUND_STRING(
            "Raises Atk, Def and\n"
            "Speed on the 2nd turn."),
        .effect = EFFECT_AWAKEN,
        .power = 0,
        .type = TYPE_FIGHTING,
        .accuracy = 0,
        .pp = 10,
        ...
        .instructBanned = TRUE,
        .skyBattleBanned = TRUE,
        .argument.twoTurnAttack = { STRINGID_PKNMABSORBINGPOWER },
        .contestEffect = CONTEST_EFFECT_IMPROVE_CONDITION_PREVENT_NERVOUSNESS,
        .contestCategory = CONTEST_CATEGORY_CUTE,
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
    ...
    [MOVE_PHASE_THROUGH] =
    {
        .name = COMPOUND_STRING("Phase Through"),
        .description = sUTurnDescription,
        .effect = EFFECT_HIT_ESCAPE,
        .power = 60,
        .type = TYPE_GHOST,
    ...
    [MOVE_COLD_CUTTER] =
    {
        .name = COMPOUND_STRING("Cold Cutter"),
        .description = COMPOUND_STRING(
            "Slices with a freezing\n"
    ...
    [MOVE_GAZER_BEAM] =
    {
        .name = COMPOUND_STRING("Gazer Beam"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BRANDING_BLADE] =
    {
        .name = COMPOUND_STRING("Branding Blade"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MEDDY_MEDS] =
    {
        .name = COMPOUND_STRING("Meddy Meds"),
        .description = COMPOUND_STRING(
            "Summons Light Screen on hit,\n"
            "heals ally if targeted."),
        .effect = EFFECT_HIT_TAKE_UR_MEDS,
        .power = 100,
        .type = TYPE_POISON,
        .accuracy = 100,
        .pp = 10,
    ...
    [MOVE_FRIGID_END] =
    {
        .name = COMPOUND_STRING("Frigid End"),
        .description = COMPOUND_STRING(
            "Slices with a frozen blade\n"
            "that is also Ice-type."),
        .effect = EFFECT_TWO_TYPED_MOVE,
        .power = 105,
        .type = TYPE_WATER,
        .accuracy = 100,
    ...
    [MOVE_BEAM_BLADE] =
    {
        .name = COMPOUND_STRING("Beam Blade"),
        .description = COMPOUND_STRING(
            "Attacks with razor-sharp\n"
            "darkness. High crit ratio."),
        .effect = EFFECT_HIT,
        .power = 100,
        .type = TYPE_DARK,
        .accuracy = 80,
    ...
    [MOVE_CALIBRATE] =
    {
        .name = COMPOUND_STRING("Calibrate"),
        .description = COMPOUND_STRING(
            "The user focuses its aim\n"
            "to raise Sp. Atk and Acc."),
    ...
    [MOVE_CHERRY_BOMB] =
    {
        .name = COMPOUND_STRING("Cherry Bomb"),
        .description = COMPOUND_STRING(
            "Tosses two explosive cherries\n"
            "at the foe that may burn."),
        .effect = EFFECT_HIT,
        .power = 35,
        .type = TYPE_FIRE,
        .accuracy = 100,
    ...
    [MOVE_EARTH_SHATTER] =
    {
        .name = COMPOUND_STRING("Earth Shatter"),
        .description = COMPOUND_STRING(
            "Erupts the ground below the\n"
            "target, hurting the user."),
        .effect = EFFECT_HIT,
        .power = 120,
        .type = TYPE_GROUND,
        .accuracy = 100,
    ...
    [MOVE_EXTINCTION] =
    {
        ...
        .description = COMPOUND_STRING(
            "Crushes the foe instantly\n"
            "with a comically slow meteor."),
        .effect = EFFECT_OHKO,
        .power = 1,
        .type = TYPE_DRAGON,
        .accuracy = 30,
    ...
    [MOVE_FRACTUS] =
    {
        .name = COMPOUND_STRING("Fractus"),
        .description = COMPOUND_STRING(
            "Destroys screens with\n"
            "sharp blades of wind."),
        .effect = EFFECT_BRICK_BREAK,
        .power = 75,
        .type = TYPE_FLYING,
        .accuracy = 100,
    ...
    [MOVE_STICKY_TONGUE] =
    {
        .name = COMPOUND_STRING("Sticky Tongue"),
        .description = COMPOUND_STRING(
            "Eats the foe's held\n"
            "item to prevent its use."),
        .effect = EFFECT_KNOCK_OFF,
        ...
        .makesContact = TRUE,
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_STICKY_TONGUE, // you have no fucking idea how much of a hassle this was to code -rex
        }),
        .contestEffect = CONTEST_EFFECT_BADLY_STARTLE_FRONT_MON,
        .contestCategory = CONTEST_CATEGORY_SMART,
        .contestComboStarterId = 0,
    ...
    [MOVE_CHAOS_DUNK] =
    {
        .name = COMPOUND_STRING("Chaos Dunk"),
        .description = COMPOUND_STRING(
            "A cosmic dunk that\n"
            "dunks the opponent."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_CLOUD_BREAKER] =
    {
        .name = COMPOUND_STRING("Cloud Breaker"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SOUL_CRUSHER] =
    {
        ...
        .priority = 0,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .argument = { .absorbPercentage = 101 }, // restores all user's HP
        .ignoresProtect = TRUE,
        .ignoresSubstitute = TRUE,
        .contestEffect = CONTEST_EFFECT_BETTER_IF_SAME_TYPE,
        .contestCategory = CONTEST_CATEGORY_SMART,
    ...
    [MOVE_METEOR_HAMMER] =
    {
        .name = COMPOUND_STRING("Meteor Hammer"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SCARLET_CHANT] =
    {
        .name = COMPOUND_STRING("Scarlet Chant"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BEAR_HUG] =
    {
        ...
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
        .argument = { .moveProperty = ARG_BEAR_HUG },
        .contestEffect = CONTEST_EFFECT_BETTER_WITH_GOOD_CONDITION,
        .contestCategory = CONTEST_CATEGORY_TOUGH,
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
    ...
    [MOVE_SUFFOCATE] =
    {
        .name = COMPOUND_STRING("Suffocate"),
        .description = COMPOUND_STRING(
            "A weak suffocation technique\n"
    ...
    [MOVE_DRUMROLL] =
    {
        .name = COMPOUND_STRING("Drumroll"),
        .description = COMPOUND_STRING(
            "Prepares a high-power\n"
            "Pokémon move at random."),
        .effect = EFFECT_DRUMROLL,
        .power = 0,
        .type = TYPE_NORMAL,
        .accuracy = 0,
        .pp = 10,
    ...
    [MOVE_SPOOPERPOWER] =
    {
        .name = COMPOUND_STRING("Spooperpower"),
        .description = COMPOUND_STRING(
            "User's highest attack stat\n"
    ...
    [MOVE_DARKENING] =
    {
        .name = COMPOUND_STRING("DARKENING"),
        .description = COMPOUND_STRING(
        ...
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .sketchBanned = TRUE,
        .argument = { .absorbPercentage = 100 }, // restores 100% HP instead of 50% HP
        .makesContact = TRUE,
        .healingMove = B_HEAL_BLOCKING >= GEN_6,
        .contestEffect = CONTEST_EFFECT_STARTLE_MON_WITH_JUDGES_ATTENTION,
        .contestCategory = CONTEST_CATEGORY_CUTE,
    ...
    [MOVE_BRUTAL_PUNISHMENT] =
    {
        ...
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .metronomeBanned = TRUE,
        .additionalEffects = ADDITIONAL_EFFECTS({ //GTODO: DONE
            .moveEffect = MOVE_EFFECT_BRUTAL_PUNISHMENT2,
            .self = TRUE,
            .chance = 100,
        }),
        .contestEffect = CONTEST_EFFECT_BETTER_IF_FIRST,
